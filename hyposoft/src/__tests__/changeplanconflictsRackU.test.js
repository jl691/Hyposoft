...
describe('change plan add asset: rackU test', () => {
    ...
    test('changeplan add asset conflicts: rackU pass', done => {
        ...
        'Test Model2', 'Test Datacenter2', ids['datacenter'],'A2', 15, rackUStatus => {
    ...
    test('changeplan add asset conflicts: rackU conflict', done => {
        ...
        changeplanconflictutils.rackUConflict(ids['changePlan'], ids['changePlanStep'], '','Test Model2', 'Test Datacenter2', ids['datacenter'],'A2', 1, rackUStatus => {
